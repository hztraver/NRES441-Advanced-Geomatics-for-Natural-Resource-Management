...
#### Q1: What is the projection, units and spatial resolution of the 2000 orthomosaic?
...
knitr::include_graphics('images/04/04-image-reg.png')
```
...
```{r, echo=FALSE, out.width = "50%", fig.align = 'center'}
knitr::include_graphics('images/04/04-tiepoint1.png')
```
...
knitr::include_graphics('images/04/04-table.png')
```
...
```{r, echo=FALSE, out.width = "50%", fig.align = 'center'}
knitr::include_graphics('images/04/04-tiepoints5.png')
```

#### Q2: What are qualities of good tie points? Check all true statements.

-   Tie points should be extremely large in size so they can be seen in both images

-   Shorelines are good locations for tie points

-   Tie points should be stable in position and appearance over time

-   Extremely tall buildings are good tie points because they are closer to the camera

-   Tie points should be larger than the spatial resolution of the image

-   Road intersections, railways, buildings and trees generally make good tie points
...
```{r, echo=FALSE, out.width = "50%", fig.align = 'center'}
knitr::include_graphics('images/04/04-bad-tie.png')
```
...
#### Q3: What differences in how and when the images were acquired might lead to challenges in matching pixel locations?
...
```{r, echo=FALSE, out.width = "30%", fig.align = 'center'}
knitr::include_graphics('images/04/04-preview.png')
```
...
#### Q4: Compare the base and warped images at different scales by zooming in and out. What image transformation appears to work the best? 
...
#### Q5: Pan around the campus maps and find examples of 2 land cover or land use changes. Take screenshots from the lab showing these areas (see example below). Use PowerPoint or any image editing software to create figures that highlights these changes (use image below as an example). Submit your figures as .png files. 

```{r, echo=FALSE, out.width = "50%", fig.align = 'center'}
knitr::include_graphics('images/04/04-figure.png')
```
...
```{r, echo=FALSE, out.width = "30%", fig.align = 'center'}
knitr::include_graphics('images/04/04-mensuration.png')
```
...
```{r, echo=FALSE, out.width = "30%", fig.align = 'center'}
knitr::include_graphics('images/04/04-error2.png')
```

```{r, echo=FALSE, out.width = "30%", fig.align = 'center'}
knitr::include_graphics('images/04/04-error.png')
```

#### Q6: Repeat this process for 4 more features (they don't have to be buildings - try to pick other features like trees or street corners). Create a table in Excel showing the estimated error in meters for each of the five features. Submit a screenshot of the table. 

#### Q7: What was the mean and range in error among your five points? 
